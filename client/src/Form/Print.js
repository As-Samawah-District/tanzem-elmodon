...
export default function Print() {
  ...
  useEffect(() => {
    ...
    const getNumber = async () => {
      ...
      if (res.ok) {
        res = await res.json();
        setNumber(res.form?.number);
        setUserName(res.form?.userName);
        setBuilding(res.form?.buildingNumber);
        setDate(res.form?.createdAt?.slice(0,10))
      }
    };
    getNumber();
  });
  ...
  return (
    <div className="flex justify-between flex-row-reverse">
      ...
      <div>
        <div className="text-center text-white w-[40%] m-auto rounded-xl p-4 mt-2">
          <Button
            variant="contained"
            style={{
              marginTop: "10px",
        ...
        <div className="flex lg:flex-row flex-col justify-between ">
          <div
            className="flex flex-col p-4 container border-black border-4 w-full lg:w-[85%] m-auto "
            dir="rtl"
          >
            <div
              className="flex flex-col gap-2 pt-2 overflow-auto"
              ref={componentRef}
              dir="rtl"
            >
              ...
              <div className="flex justify-between w-[80%] m-auto">
                ...
                <h1 className="text-base font-normal mr-[6rem]">
                  رقم العقار / {buildingNumber}{" "}
                </h1>
              </div>
              ...
              <div className="flex justify-between w-[80%] m-auto">
                <h1 className="text-base font-normal">
                  {" "}
                  التاريخ:&nbsp; {date?.split("-")[2]}/{date?.split("-")[1]}/
                  {date?.split("-")[0]}
                </h1>
                <h1 className="text-base font-normal  ">
                  رقم الاستماره / {formNumber}
              ...
              <h1 className="text-base font-bas w-[80%] m-auto">
                {" "}
                استمارة وصف الشارع المطلة عليه العقار المرقم ({
                  buildingNumber
                }){" "}
              </h1>
              ...
              <div className="flex w-[80%] m-auto justify-between flex-wrap gap-1">
                ...
                <div className="border-black border-2 flex flex-col w-full px-2 py-1">
                  <div>رقم الوصل وتاريخه/</div>
                  <div>المجموع</div>
                </div>
                <div className="flex justify-between w-full px-4">
                  <div className="font-bold">مساح القسم البلدي</div>
                  <div className="font-bold ml-[15%]">مساح القسم البلدي</div>
                </div>
                <div className="flex justify-between w-full px-4 mt-6">
                  <div className="font-bold">اسم محاسب</div>
                  <div className="font-bold ml-[15%]">اسم مدقق</div>
                </div>
                ...
                <p>
                  {" "}
                  <b>ملاحظه :</b>
                  الاستمارة خالية من الحك والشطب وفي حال ذلك تعتبر مزورة
                  (الاستمارة صالحة لمدة ٦٠يوم من تاريخ الصادر)
                </p>
              </div>
            </div>
          </div>
